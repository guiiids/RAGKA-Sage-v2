...
class OpenAIService:
    ...
    def get_chat_response(
        ...
        **kwargs
        ...
        logger.debug(
            f"Using max_tokens: {max_tokens}, max_completion_tokens: {max_completion_tokens}, temperature: {temperature}, top_p: {top_p}"
        )
    ...
    def get_chat_response_stream(
        ...
        **kwargs
        ...
        logger.debug(
            f"(stream) Using max_tokens: {max_tokens}, max_completion_tokens: {max_completion_tokens}, temperature: {temperature}, top_p: {top_p}"
        )
        try:
